...
=======
	.. //FIXME: 리스닝? 폴링? -> https://err0rcode7.github.io/backend/2021/06/19/%EB%A9%94%EC%8B%9C%EC%A7%80-%ED%81%90%EC%99%80-%EC%A2%85%EB%A5%98-%EA%B7%B8%EB%A6%AC%EA%B3%A0-%EB%B9%84%EA%B5%90.html
	- 소비자는 메시지를 수신하기 위해 Queue를 실시간으로 리스닝한다.
	.. //FIXME: 왜 큐를 소비자 수 만큼 둔 것이 효율이 높은가? -> chatGPT 내용 정리 필요!
>>>>>>> 890f0cb (modify rabbitmq)
